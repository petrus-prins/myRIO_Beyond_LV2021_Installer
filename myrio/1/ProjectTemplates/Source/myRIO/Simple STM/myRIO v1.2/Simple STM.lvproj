...
<Project Type="Project" LVVersion="13008000">
	...
	<Property Name="NI.Project.Description" Type="Str">This sample project uses the Simple TCP/IP Messaging (STM) Reference Library to transmit messages. This network communication system provides meta data to reduce the data transmitted.</Property>
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Project Documentation" Type="Folder">
			<Item Name="Simple TCP Messaging Documentation.html" Type="Document" URL="../documentation/Simple TCP Messaging Documentation.html"/>
		</Item>
		<Item Name="Sub VIs" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="Connection Info.ctl" Type="VI" URL="../Sub VIs/Connection Info.ctl"/>
			<Item Name="Close connection.vi" Type="VI" URL="../Sub VIs/Close connection.vi"/>
			<Item Name="Read message.vi" Type="VI" URL="../Sub VIs/Read message.vi"/>
			<Item Name="Read meta data.vi" Type="VI" URL="../Sub VIs/Read meta data.vi"/>
			<Item Name="Write message.vi" Type="VI" URL="../Sub VIs/Write message.vi"/>
			<Item Name="Write meta data.vi" Type="VI" URL="../Sub VIs/Write meta data.vi"/>
		</Item>
