...
<Project Type="Project" LVVersion="13008000">
	...
	<Property Name="NI.Project.Description" Type="Str">This sample uses message queue and dispatcher to transmit messages. This network communication system can communicate among different processes.</Property>
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Project Documentation" Type="Folder">
			<Item Name="Queued Message Documentation.html" Type="Document" URL="../documentation/Queued Message Documentation.html"/>
		</Item>
		<Item Name="Sub VIs" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="Action.ctl" Type="VI" URL="../Sub VIs/Action.ctl"/>
			<Item Name="Message.ctl" Type="VI" URL="../Sub VIs/Message.ctl"/>
			<Item Name="Create Message Queue.vi" Type="VI" URL="../Sub VIs/Create Message Queue.vi"/>
			<Item Name="Create Network Message.vi" Type="VI" URL="../Sub VIs/Create Network Message.vi"/>
			<Item Name="Dispatch Message.vi" Type="VI" URL="../Sub VIs/Dispatch Message.vi"/>
			<Item Name="Read Next Message.vi" Type="VI" URL="../Sub VIs/Read Next Message.vi"/>
			<Item Name="Receive Message via UDP.vi" Type="VI" URL="../Sub VIs/Receive Message via UDP.vi"/>
			<Item Name="Send Message via UDP.vi" Type="VI" URL="../Sub VIs/Send Message via UDP.vi"/>
			<Item Name="UDP Connection Manager.vi" Type="VI" URL="../Sub VIs/UDP Connection Manager.vi"/>
		</Item>
	...
	<Item Name="myRIO" Type="RT myRIO">
		...
		<Property Name="CCSymbols" Type="Str">TARGET_TYPE,RT;OS,Linux;CPU,ARM;DeviceCode,76D3;</Property>
