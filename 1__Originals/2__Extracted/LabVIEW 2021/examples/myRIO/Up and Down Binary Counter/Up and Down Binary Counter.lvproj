...
<Project Type="Project" LVVersion="12008004">
	...
	<Property Name="NI.Project.Description" Type="Str">This example monitors the myRIO onboard button and increments/decrements a counter with each button press based on the user-specified count direction.</Property>
